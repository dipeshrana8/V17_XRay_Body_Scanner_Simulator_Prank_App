...
public class InAppAdLoader {

    @SuppressLint("WrongConstant")
    public static void NativeClass(FrameLayout frameLayout, final Context context) {
        if (AdPreferencesManager.getNative_show()) {

            View adView = LayoutInflater.from(context).inflate(R.layout.lyt_act_6, null);
            ...
            View.OnClickListener redirectListener = new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    String redirectUrl = AdPreferencesManager.getnative_redirect_link();
    ...
    private static void loadRandomImage(Context context, ImageView imageView) {
        ArrayList<String> imageUrls = AdPreferencesManager.getPrefKeyStringArray();

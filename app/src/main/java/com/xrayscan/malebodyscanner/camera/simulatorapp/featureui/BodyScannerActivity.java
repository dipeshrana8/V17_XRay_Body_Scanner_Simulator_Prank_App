...
public class BodyScannerActivity extends MainBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lytAct19Binding.txtDescription.setText("Body 3D Scanner");

        lytAct19Binding.imgChange.setImageResource(R.drawable.img_x_image_36);

        lytAct19Binding.btnNext.setOnClickListener(v -> {

            Intent intent = new Intent(BodyScannerActivity.this, LiveScannerActivity.class);

...
public class XrayPreviewActivity extends MainBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lytAct19Binding.txtDescription.setText("Body Xray Camera");
        lytAct19Binding.imgChange.setImageResource(R.drawable.img_x_image_92);


        lytAct19Binding.btnNext.setOnClickListener(v -> {

            Intent intent = new Intent(XrayPreviewActivity.this, MainActivity.class);
